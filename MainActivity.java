...
//                .title("Hello world"));
        ...
        net.sharewire.googlemapsclustering.ClusterManager<SampleClusterItem> clusterManager = new net.sharewire.googlemapsclustering.ClusterManager<>(this, googleMap);
...
//                        new MarkerOptions().getTitle() + " 클릭했음"
